...
void bookObjects()
{
    ...
    fTofK->SetParameters(-0.0439496, -0.225184, -0.146362, 1.57646, -0.001271, -0.251801, 0.688937);
    fTofPi = new TF1("fTofPi","[0]/(pow(x-[1],2)+[2])-[4]/(exp(x-[3])+[5])+[6]",0.2,3);
    fTofPi->SetParameters(-0.117542, -2.89792, -8.93689, -0.206938, 2.54462e-05, -1.68743, 0.712684);
    fTofP = new TF1("fTofP","[0]/(pow(x-[1],2)+[2])-[4]/(exp(x-[3])+[5])+[6]",0.2,3);
    fTofP->SetParameters(-0.0202961, 0.239103, 0.0288012, -0.199342, -0.00070451, -1.70902, 0.699816);
