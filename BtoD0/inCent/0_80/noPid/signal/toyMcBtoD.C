...
void bookObjects()
{
    ...
    h3PiKPNumber = (TH3I*)fDaughters.Get("h3PiKPNumber0_80");
    ...
    fTofK->SetParameters(0.320138, 0.273588, 0.336521, 1.27271, 0.22162, -0.194098, 0.62435);
    fTofPi = new TF1("fTofPi","[0]/(pow(x-[1],2)+[2])-[4]/(exp(x-[3])+[5])+[6]",0.2,3);
    fTofPi->SetParameters(-0.0886229, -2.89503, -8.9491, -0.199496, 9.83245e-08, -1.69784, 0.627562);
    fTofP = new TF1("fTofP","[0]/(pow(x-[1],2)+[2])-[4]/(exp(x-[3])+[5])+[6]",0.2,3);
    fTofP->SetParameters(-0.0118781, 0.254265, 0.0203767, -0.199443, 2.19306e-05, -1.69736, 0.62015);
    
    cout << "Loading D0/B pT weight ..." << endl;
    TFile fD0PtWeight("D0Pt_Wg.root"); //0-12GeV
    hD0PtWgFonll = (TH1F*)fD0PtWeight.Get("hD0Pt_wg_0_80");
    hD0PtWgFonll->SetDirectory(0);
    hBPtWgFonll = (TH1F*)fD0PtWeight.Get("hBPt_wg_0_80");
