...
TH2F* h2massSig_D0;  //prompt D0, add cosTheta and D0Dca cut
TH2F* h2massBg_D0;
TH2F* h2massSigDoubleCount_D0;

//efficiency
TH1F* hD0pT_noCut;
TH1F* hD0pT_Cut;
TH1F* hPromptD0pT_Cut;
TH1F* hD0pT_Cut_doubleCount;
...
namespace anaCuts
{
    ...
    float const cosTheta[nPtBins] = {0.5, 0.6, 0.75, 0.9, 0.95};
...
void DefineHist() {
    ...
    h2massSig_D0 = new TH2F("h2massSig_D0","h2massSig_D0;D0 pT;mass(kpi)",200,0,20,50,1.6,2.1);  //prompt D0, add cosTheta and D0Dca cut
    h2massSig_D0->SetDirectory(0);
    h2massBg_D0 = new TH2F("h2massBg_D0","h2massBg_D0;D0 pT;mass(kpi)",200,0,20,50,1.6,2.1);
    h2massBg_D0->SetDirectory(0);
    h2massSigDoubleCount_D0 = new TH2F("h2massSigDoubleCount_D0","h2massSigDoubleCount_D0;D0 pT;mass(kpi)",200,0,20,50,1.6,2.1);
    h2massSigDoubleCount_D0->SetDirectory(0);
    ...
    hPromptD0pT_Cut = new TH1F("hPromptD0pT_Cut","hPromptD0pT_Cut",200,0,20);
    hPromptD0pT_Cut->SetDirectory(0);
    hD0pT_Cut_doubleCount = new TH1F("hD0pT_Cut_doubleCount","hD0pT_Cut_doubleCount",200,0,20);
    hD0pT_Cut_doubleCount->SetDirectory(0);
    ...
    hptTotal = new TH1F("hptTotal","hptTotal",200,0,20);
    hptTotal->SetDirectory(0);
    hpt1 = new TH1F("hpt1","k/pi pT>1.6",200,0,20);
    hpt1->SetDirectory(0);
    hpt2 = new TH1F("hpt2","k/pi one pT< 1.6",200,0,20);
    hpt2->SetDirectory(0);
    hpt3 = new TH1F("hpt3","k/pi both pT<1.6",200,0,20);
    hpt3->SetDirectory(0);
}
//write hist
void WriteHist(TFile* fout) {
    ...
    h2massSig_D0->Write();  //prompt D0, add cosTheta and D0Dca cut
    h2massBg_D0->Write();
    h2massSigDoubleCount_D0->Write();
    hD0pT_noCut->Write();
    hD0pT_Cut->Write();
    hPromptD0pT_Cut->Write();
    hD0pT_Cut_doubleCount->Write();
    h2D0DcaSig->Write();
    h2D0DcaBg->Write();
...
void DeleteHist() {
    ...
    if(h2massSig_D0) { delete h2massSig_D0; h2massSig_D0 = NULL; }
    if(h2massBg_D0) { delete h2massBg_D0; h2massBg_D0 = NULL; }
    if(h2massSigDoubleCount_D0) { delete h2massSigDoubleCount_D0; h2massSigDoubleCount_D0 = NULL; }
    if(hD0pT_noCut) { delete hD0pT_noCut; hD0pT_noCut = NULL; }
    if(hD0pT_Cut) { delete hD0pT_Cut; hD0pT_Cut = NULL; }
    if(hPromptD0pT_Cut) { delete hPromptD0pT_Cut; hPromptD0pT_Cut = NULL; }
    if(hD0pT_Cut_doubleCount) { delete hD0pT_Cut_doubleCount; hD0pT_Cut_doubleCount = NULL; }
    ...
    if(hptTotal) { delete hptTotal; hptTotal = NULL; }
    if(hpt1) { delete hpt1; hpt1 = NULL; }
    if(hpt2) { delete hpt2; hpt2 = NULL; }
    if(hpt3) { delete hpt3; hpt3 = NULL; }
}
void DefineTree() {
